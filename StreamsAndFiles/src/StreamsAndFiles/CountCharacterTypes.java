...
public class CountCharacterTypes {
    public static void main(String[] args) {
        ...
        File countChars = new File("/home/anton/Downloads/SoftUni/count-chars.txt");

        try (BufferedReader reader = new BufferedReader(new FileReader("/home/anton/Downloads/SoftUni/words.txt"))) {
